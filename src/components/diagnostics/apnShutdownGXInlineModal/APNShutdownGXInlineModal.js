...
function ApnShutdownGXInlineModal(props) {
  const classes = useStyles();
  const [GXInlineModalShow, setGXInlineModalShow] = React.useState(false);
  ...
  const handleClose = () => {
    ...
    return (
        ...
        >
          <DialogTitle id="max-width-dialog-title">GX Inline - APN Shutdown Warning</DialogTitle>
          <DialogContent>
          ...
          <DialogActions>
          <span onClick={() => setGXInlineModalShow(true)}>
          <GXInlineModal show={GXInlineModalShow} onHide={() => setGXInlineModalShow(false) } />
          </span>
  ...
  export default ApnShutdownGXInlineModal;