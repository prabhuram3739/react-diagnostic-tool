import React from "react";
  ...
  function ClearSubscriberModal(props) {
    ...
    const handleClose = () => {
      ...
      return (
          ...
          ><form className={classes.form} >
            <DialogTitle id="max-width-dialog-title">Clear Subscriber</DialogTitle>
            <DialogContent>
                      ...
                      <Table size="medium" style={{ width: 900 }} >
                          ...
                          <TableRow>
                              <TableCell align="left" className={classes.boaderlessTr}>
                                  <TextField label="IMSI" style={{ margin: 8 }} placeholder="IMSI" fullWidth margin="normal" required />
                              </TableCell>
                          </TableRow>                                                                                                                                                                                                                                                                                                                                                                                                                                                              
                          </TableBody>
                      </Table>
  ...
  export default ClearSubscriberModal;